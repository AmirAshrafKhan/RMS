...
const CommonDeletModal = ({ isConfirm, closeConfirm }) => {
    ...
    <>
      ...
      >
        ...
        <Form noValidate validated={validated} onSubmit={handleSubmit}>
          ...
          <Modal.Footer>
            <CommonButton type="submit" title="Cancel" />
            <CommonButton type="submit" title="Delete" />
          </Modal.Footer>
        </Form>
      </Modal>
    </>
...
export default CommonDeletModal;
